...
Work In Progress.
## Training Distilgpt2
The y-axis of the graph is in validation loss and the x-axis is in epochs. The eight curves have different learning-rates expressed in euler number (en = 2.71828) raised to a negative power. The learning-rates from low-to-high at epoch 0 of the eight curves is as follows:    
